...
export default defineSchema({
  ...
  scans: defineTable({
    ...
    recommendationStatus: v.optional(v.union(v.literal('recommended'), v.literal('not_recommended'), v.literal('unassessed'), v.literal('not_mentioned'))),
    recommendationEvidence: v.optional(nullableString),
    recommendationMethod: v.optional(nullableString),
