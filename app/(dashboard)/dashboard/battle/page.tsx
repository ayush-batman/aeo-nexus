        ...
        <div className="p-8 max-w-5xl mx-auto space-y-8">
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-[var(--text-secondary)]">Your Brand</label>
                            <Input
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-[var(--text-secondary)]">Competitor</label>
                            <Input
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-[var(--text-secondary)]">Battleground (Product Category / Query)</label>
                        <Input
            ...
            {scanning && (
                <div className="space-y-6 animate-pulse mt-8">
                    <Skeleton className="h-48 w-full rounded-xl bg-[var(--bg-surface)]" />
                    <div className="grid md:grid-cols-2 gap-6">
                        <Skeleton className="h-32 w-full rounded-xl bg-[var(--bg-surface)]" />
                        <Skeleton className="h-32 w-full rounded-xl bg-[var(--bg-surface)]" />
                    </div>
                </div>
            )}
            ...
            {result && (
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        {/* Competitor Stats */}
                        <Card className="bg-[var(--bg-surface)] border-[var(--border-default)] border-l-4 border-l-orange-500">
                            <CardHeader>
