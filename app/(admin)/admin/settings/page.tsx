        ...
        <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                        <label className="flex items-center justify-between">
                            ...
                            <input type="checkbox" defaultChecked className="w-5 h-5 rounded bg-[var(--surface-elevated)] border-[var(--border)] text-violet-600 focus:ring-violet-500" />
                        </label>
                        <label className="flex items-center justify-between">
                        ...
                        <label className="flex items-center justify-between">
                            ...
                            <input type="checkbox" className="w-5 h-5 rounded bg-[var(--surface-elevated)] border-[var(--border)] text-violet-600 focus:ring-violet-500" />
                        </label>
                    </div>
                </div>
                ...
                <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="text-[var(--text-muted)] text-sm mb-1 block">Stripe Webhook Secret</label>
                            <input
                                type="password"
                                value="••••••••••••••••"
                                readOnly
                                className="w-full px-3 py-2 bg-[var(--surface-elevated)] border border-[var(--border)] rounded-lg text-[var(--text-ghost)]"
                            />
                        </div>
                        <div>
                            <label className="text-[var(--text-muted)] text-sm mb-1 block">OpenAI API Key</label>
                            <input
                                type="password"
                                value="••••••••••••••••"
                                readOnly
